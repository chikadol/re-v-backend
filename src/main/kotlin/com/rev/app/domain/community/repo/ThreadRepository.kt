...
interface ThreadRepository : JpaRepository<Thread, Long> {
    @Query("""
select t from Thread t where t.boardId = :boardId and (:cursorCreatedAt is null or (t.createdAt < :cursorCreatedAt or (t.createdAt = :cursorCreatedAt and t.id < :cursorId))) order by t.createdAt desc, t.id desc
""")
