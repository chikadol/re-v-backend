-- V2__community_nonpoly.sql — Community schema (non‑polymorphic) for RE:V
...
CREATE INDEX IF NOT EXISTS idx_board_slug ON board(slug);
...
CREATE INDEX IF NOT EXISTS idx_thread_board_created ON thread(board_id, created_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_thread_attachment_thread ON thread_attachment(thread_id);
...
CREATE INDEX IF NOT EXISTS idx_comment_thread_created ON comment(thread_id, created_at ASC);
...
CREATE INDEX IF NOT EXISTS idx_thread_reaction_thread ON thread_reaction(thread_id);
...
CREATE INDEX IF NOT EXISTS idx_thread_report_thread ON thread_report(thread_id);
...
CREATE INDEX IF NOT EXISTS idx_comment_report_comment ON comment_report(comment_id);
...
CREATE INDEX IF NOT EXISTS idx_thread_modlog_thread ON thread_moderation_log(thread_id);
...
CREATE INDEX IF NOT EXISTS idx_comment_modlog_comment ON comment_moderation_log(comment_id);
