...
import com.rev.app.api.community.dto.BoardDto
import com.rev.app.api.community.dto.ThreadDto
import com.rev.app.api.community.dto.boardDto
import com.rev.app.api.community.dto.threadDto
...
class BoardController(private val svc: BoardService) {
    ...
    @GetMapping("/{slug}")
    fun getBoard(@PathVariable slug: String): BoardDto = boardDto(svc.getBoardBySlug(slug))
